document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      galleryCTAEyebrow: "Visual Showcase",
      galleryCTATitle: "Check Out My Gallery",
      galleryCTACopy: "I also have a gallery where I share some of my creative work and projects. Feel free to take a look if you're interested!",
      galleryCTAButton: "Explore Gallery",
    ...
    pl: {
      ...
      galleryCTAEyebrow: "Galeria Wizualna",
      galleryCTATitle: "Sprawdz moja Galerie",
      galleryCTACopy: "Mam takze galerie, gdzie dziele sie swoimi pracami i projektami. Zapraszam do obejrzenia!",
      galleryCTAButton: "Odwiedz Galerie",
